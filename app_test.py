"""
Multi-Agent AI Deep Researcher with Google Gemini (FREE)
Install: pip install streamlit langchain langchain-google-genai langgraph tavily-python python-dotenv
...
@st.cache_resource
def init_tools():
    """Initialize Gemini LLM and Tavily search"""
...
st.markdown("*Powered by Google Gemini (FREE) + Tavily Search + LangGraph*")
...
# Footer
st.markdown("---")
st.caption("Built with ❤️ using Google Gemini (FREE), Tavily Search, LangGraph & Streamlit")